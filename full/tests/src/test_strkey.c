...
void test_decode_ed25519_public_key(void **state) {
  char *in = "GB777MJSHL7QOVZ3S52M2MROORDKLSJQL6MUSBV57R2NW7LODWORELJO";
  unsigned char out[32];
  assert_true(decode_ed25519_public_key(in, out));
  unsigned char expected_out[] = {
      ...
      0x6,  0xbd, 0xfc, 0x74, 0xdb, 0x7d, 0x6e, 0x1d, 0x9d, 0x12};
  assert_memory_equal(out, expected_out, 32);
}
...
void test_decode_med25519_public_key(void **state) {
  char *in =
      "MB777MJSHL7QOVZ3S52M2MROORDKLSJQL6MUSBV57R2NW7LODWOREAAAAAAAAAAE2K4YI";
  stellarxdr_MuxedAccountMed25519 out;
  stellarxdr_MuxedAccountMed25519 expected_out = {
      .ed25519 = {0x7f, 0xff, 0xb1, 0x32, 0x3a, 0xff, 0x7,  0x57,
                  0x3b, 0x97, 0x74, 0xcd, 0x32, 0x2e, 0x74, 0x46,
                  0xa5, 0xc9, 0x30, 0x5f, 0x99, 0x49, 0x6,  0xbd,
                  0xfc, 0x74, 0xdb, 0x7d, 0x6e, 0x1d, 0x9d, 0x12},
  ...
  assert_true(decode_med25519_public_key(in, &out));
  assert_memory_equal(out.ed25519, expected_out.ed25519, 32);
  assert_int_equal(out.id, expected_out.id);
}
...
void test_decode_ed25519_secret_seed(void **state) {
  char *in = "SB777MJSHL7QOVZ3S52M2MROORDKLSJQL6MUSBV57R2NW7LODWORFP2R";
  unsigned char out[32];
  assert_true(decode_ed25519_secret_seed(in, out));
  unsigned char expected_out[] = {
      0x7f, 0xff, 0xb1, 0x32, 0x3a, 0xff, 0x7,  0x57, 0x3b, 0x97, 0x74,
      0xcd, 0x32, 0x2e, 0x74, 0x46, 0xa5, 0xc9, 0x30, 0x5f, 0x99, 0x49,
      0x6,  0xbd, 0xfc, 0x74, 0xdb, 0x7d, 0x6e, 0x1d, 0x9d, 0x12};
...
void test_decode_pre_auth_tx(void **state) {
  char *in = "TB777MJSHL7QOVZ3S52M2MROORDKLSJQL6MUSBV57R2NW7LODWORFW37";
  unsigned char out[32];
  assert_true(decode_pre_auth_tx(in, out));
  unsigned char expected_out[] = {
      0x7f, 0xff, 0xb1, 0x32, 0x3a, 0xff, 0x7,  0x57, 0x3b, 0x97, 0x74,
      0xcd, 0x32, 0x2e, 0x74, 0x46, 0xa5, 0xc9, 0x30, 0x5f, 0x99, 0x49,
      0x6,  0xbd, 0xfc, 0x74, 0xdb, 0x7d, 0x6e, 0x1d, 0x9d, 0x12};
...
void test_decode_sha256_hash(void **state) {
  char *in = "XB777MJSHL7QOVZ3S52M2MROORDKLSJQL6MUSBV57R2NW7LODWORES6G";
  unsigned char out[32];
  assert_true(decode_sha256_hash(in, out));
  unsigned char expected_out[] = {
      0x7f, 0xff, 0xb1, 0x32, 0x3a, 0xff, 0x7,  0x57, 0x3b, 0x97, 0x74,
      0xcd, 0x32, 0x2e, 0x74, 0x46, 0xa5, 0xc9, 0x30, 0x5f, 0x99, 0x49,
      0x6,  0xbd, 0xfc, 0x74, 0xdb, 0x7d, 0x6e, 0x1d, 0x9d, 0x12};
...
int main() {
  const struct CMUnitTest tests[] = {
      ...
      cmocka_unit_test(test_decode_ed25519_public_key),
      cmocka_unit_test(test_encode_med25519_public_key),
      cmocka_unit_test(test_decode_med25519_public_key),
      cmocka_unit_test(test_encode_ed25519_secret_seed),
      cmocka_unit_test(test_decode_ed25519_secret_seed),
      cmocka_unit_test(test_encode_pre_auth_tx),
      cmocka_unit_test(test_decode_pre_auth_tx),
      cmocka_unit_test(test_encode_sha256_hash),
      cmocka_unit_test(test_decode_sha256_hash),
  };
